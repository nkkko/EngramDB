...
EngramDB now includes built-in support for generating embeddings directly from text using machine learning models. This means you can:
...
See the [Embeddings](/advanced-topics/embeddings) documentation for more details.
