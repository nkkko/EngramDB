...
mod tests {
    ...
    use crate::vector::{
        create_vector_index, MultiVectorIndex, MultiVectorIndexConfig, MultiVectorSimilarityMethod,
    ...
    fn test_embedding_service_with_multi_vector() {
        ...
        let multi_vec = service
            .generate_multi_vector_for_document(text, None)
            .unwrap();
    ...
    fn test_multi_vector_index() {
        ...
        for doc in &documents {
            let multi_vec = service
                .generate_multi_vector_for_document(doc, None)
                .unwrap();
            let node = MemoryNode::with_multi_vector(multi_vec);
            nodes.push(node);
        }
        ...
        let multi_vec_query = service
            .generate_multi_vector_for_query("vector search algorithms")
            .unwrap();
    ...
    fn test_multi_vector_factory() {
        ...
        // Test search
        let multi_vec_query = service
            .generate_multi_vector_for_query("vector search")
            .unwrap();
